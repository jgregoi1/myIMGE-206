...
using CourseLib;
using Jacques_PeopleLib;
using System.ComponentModel;

namespace Jacques_Gregoire_people_app
{
    class PeopleApp
    {
        ...
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (thisPerson.GetType() == typeof(Student))
            {
                ...
                do
                {
                    Console.WriteLine("please enter a course code. I.e IGME-200");
                    courseCode = Console.ReadLine();
                    if (courseCode.Length > 0) { 
                    thisStudent.courseCode.Add(courseCode);
                        }
